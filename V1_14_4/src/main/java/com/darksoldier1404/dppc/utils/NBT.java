...
public class NBT {
    ...
    public static ItemStack setObjectTag(ItemStack objitem, String key, Object value) {
        final net.minecraft.server.v1_14_R1.ItemStack item = CraftItemStack.asNMSCopy(objitem);
    ...
    public static ItemStack removeTag(ItemStack objitem, String key) {
        net.minecraft.server.v1_14_R1.ItemStack item = CraftItemStack.asNMSCopy(objitem);
